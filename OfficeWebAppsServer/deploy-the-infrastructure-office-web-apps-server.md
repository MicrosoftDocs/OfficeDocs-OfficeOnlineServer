---
title: 'Deploy the infrastructure: Office Web Apps Server'
TOCTitle: 'Deploy the infrastructure: Office Web Apps Server'
ms:assetid: ec93a103-8072-435f-9e80-897c0aa7b914
ms:mtpsurl: https://technet.microsoft.com/en-us/library/JJ219458(v=office.15)
...
**Summary:** Contains articles about Office Web Apps Server and how it provides Office Web Apps functionality to hosts.
...
<tbody>
<tr class="odd">
<td><p><a href="office-web-apps-server-overview.md">Office Web Apps Server overview</a></p></td>
<td><p>Learn how Office Web Apps Server provides browser-based Office functionality to on-premises hosts in your organization.</p></td>
</tr>
<tr class="even">
<td><p><a href="plan-office-web-apps-server.md">Plan Office Web Apps Server</a></p></td>
<td><p>Learn about Office Web Apps Server requirements, such as HTTPS, certificates, virtualization, load balancing, topologies, and security.</p></td>
</tr>
<tr class="odd">
<td><p><a href="deploy-office-web-apps-server.md">Deploy Office Web Apps Server</a></p></td>
<td><p>Learn how to deploy Office Web Apps Server on-premises.</p></td>
</tr>
<tr class="even">
<td><p><a href="technical-reference-for-office-web-apps-server.md">Technical reference for Office Web Apps Server</a></p></td>
<td><p>Find technical reference articles for Office Web Apps Server. These include help for the OfficeWebApps Windows PowerShell cmdlets.</p></td>
</tr>
</tbody>
</table>
